...
reviews = Review.create!([
  ...
  { booking_id: bookings[14].id, reviewer_id: users[3].id, body: 'Jack is a great host that goes out of his way to accommodate your needs be it with check in or check out. She is very flexible, his communication response is very fast, thorough and accurate, and very pleasant.', rating: 5 },
