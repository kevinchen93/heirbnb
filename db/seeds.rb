...
listings = Listing.create!([
  { host_id: users[0].id, lat: '1', lng: '1', title: 'Central Park View with Private Bath', description: '4 guests, 1 bedrooms, 1 beds, Enjoy Central Park views from your bedroom window! This is the ideal room for those who like easy access to the high energy city by day, but prefer to come home to a peaceful, tree-lined neighborhood to get a good night of rest. Please read the whole profile, most of your questions will be answered below! :), From $199 per night' },
  { host_id: users[1].id, lat: '2', lng: '2', title: 'Sunny, Modern Room in East Village!', description: 'This clean and very comfortable room in the East Village has spectacular views of downtown Manhattan and is a block away from Tompkins Square Park and we are very excited to share our space with you! Thanks for taking a look., From $99 per night' },
  { host_id: users[2].id, lat: '3', lng: '3', title: 'Clean Room, Central Location in Manhattan', description: 'This apartment is a 1-minute walk from 3 major subway lines, and centrally-located between midtown and downtown - offering easy access to most of NYC’s tourist attractions. It is situated on the border between the young and stylish East Village/Lower East Side neighborhoods, and just steps from countless inexpensive restaurants, cafes, bars, galleries and shops. A memory-foam bed, Netflix, and recent-renovation provide comfort and complete the authentic New York experience!, From $197 per night' },
  { host_id: users[3].id, lat: '4', lng: '4', title: 'GREAT Location in Chelsea!', description: 'Lovely, quiet bedroom in amazing Chelsea location. Close to West Village, Meatpacking, Hell\'s Kitchen, East Village, Times Square - all the best neighborhoods! Very close to the C/E, 1, and F/M lines. Live like a local!' },
  { host_id: users[4].id, lat: '5', lng: '5', title: '\'The Country\' And The NYC Waterfront!', description: '4 guests, 2 studios, 3 bed, 1 bath, This is a comfortable studio apartment with exposed brick that has a true city feeling. This studio has a newly renovate bathroom and kitchen with stainless steel appliances., From $121 per night' },
  { host_id: users[1].id, lat: '5', lng: '5', title: 'Brownstone Studio', description: '4 guests, 1 studio, 3 bed, 1 bath, Location, location, location! Large, classy, timeless, comfortable, entire top floor with private entrance in our private house out of a 1890\'s novel in Williamsburg, Brooklyn one block from the East River. So easy to get to Manhattan by subway, ferry, cab or even foot, and all the best places in the "Burg" Wifi/cableTV/air/heat. (We stay in our separate floor below you never compromising your privacy!), From $121 per night' },
...
reviews = Review.create!([
  ...
  { booking_id: bookings[9].id, reviewer_id: users[2].id, body: 'Jack is a great host that goes out of his way to accommodate your needs be it with check in or check out. He is very flexible, her communication response is very fast, thorough and accurate, and very pleasant.', rating: 5 },
  ...
  { booking_id: bookings[14].id, reviewer_id: users[3].id, body: 'Jack is a great host that goes out of her way to accommodate your needs be it with check in or check out. She is very flexible, his communication response is very fast, thorough and accurate, and very pleasant.', rating: 5 },
