...
listings = Listing.create!([
  { host_id: users[0].id, lat: '1', lng: '1', title: 'Central Park View with Private Bath', description: 'Enjoy Central Park views from your bedroom window! This is the ideal room for those who like easy access to the high energy city by day, but prefer to come home to a peaceful, tree-lined neighborhood to get a good night of rest. Please read the whole profile, most of your questions will be answered below! :)', guests: 4, bedrooms: 1, beds: 1, baths: 2, prices: 199, img_url: 'https://a0.muscache.com/im/pictures/fb9a3c6f-a826-451a-ba42-23151380a41b.jpg?aki_policy=xx_large' },
